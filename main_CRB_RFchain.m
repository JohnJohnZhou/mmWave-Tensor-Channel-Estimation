...
Function: the CRB and algorithm versus number of RF chains(M1)
Date: Oct./2016
Author: Zhou Zhou
...
ff=1;
Q_all=exp(1j*2*pi*rand(M1(end),N1));
...
tensor_RFchains_MSE.M1=M1;
tensor_RFchains_MSE.crb_theta_1=crb_theta_1;
tensor_RFchains_MSE.crb_theta_2=crb_theta_2;
tensor_RFchains_MSE.crb_theta_3=crb_theta_3;
tensor_RFchains_MSE.crb_alpha=crb_alpha;
tensor_RFchains_MSE.error_theta_1=error_theta_1;
tensor_RFchains_MSE.error_theta_2=error_theta_2;
tensor_RFchains_MSE.error_theta_3=error_theta_3;
tensor_RFchains_MSE.error_alpha=error_alpha;
tensor_RFchains_MSE.error_H=error_H;
tensor_RFchains_MSE.iter=iter;
